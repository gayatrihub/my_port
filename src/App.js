...
<section className="bg-black bg-opacity-40 rounded-3xl shadow-lg p-8 mb-16 w-full">
  ...
  {/* Hero Section */}
<div className="relative group mx-auto mt-10 w-60 h-60 sm:w-64 sm:h-64 rounded-full overflow-visible animate-float-bounce z-10">
  {/* 🌈 Animated gradient ring with glow */}
  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-500 via-yellow-400 via-green-400 via-blue-500 to-purple-600 animate-spin-slow blur-[6px] opacity-80 z-0"></div>

  {/* 🌟 Outer glow pulse ring */}
  <div className="absolute inset-2 rounded-full border-4 border-white/10 bg-black bg-opacity-40 backdrop-blur-lg animate-pulse-fast z-10 shadow-[0_0_30px_10px_rgba(255,255,255,0.1)]"></div>

  {/* 🖼 Profile Image */}
  <img
    src="circle_profile.png"
    alt="Gayatri"
    className="relative z-20 w-full h-full object-cover rounded-full border-4 border-white shadow-[0_0_50px_rgba(255,255,255,0.2)] transition-transform duration-700 ease-in-out group-hover:scale-110"
  />

  {/* ✨ Highlight particle */}
  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-5 h-5 bg-white rounded-full opacity-50 animate-ping z-30"></div>
