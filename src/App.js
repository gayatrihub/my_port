...
<div className="relative group mx-auto mt-10 w-60 h-60 sm:w-64 sm:h-64">
  {/* 🎨 Glowing animated border ring (visible now) */}
  <div className="absolute inset-0 rounded-full p-[5px] animate-spin-slow bg-gradient-to-r from-pink-500 via-yellow-400 via-green-400 via-blue-500 to-purple-600">
    <div className="w-full h-full rounded-full bg-black bg-opacity-20 backdrop-blur-md"></div>
  </div>
