...
<section className="bg-black bg-opacity-40 rounded-3xl shadow-lg p-8 mb-16 w-full">
  ...
  {/* Hero Section */}
<div className="relative group mx-auto mt-12 w-60 h-60 sm:w-64 sm:h-64">
  {/* ✨ Floating sparkles */}
  <div className="absolute inset-0 z-20 pointer-events-none">
    {[...Array(10)].map((_, i) => (
      <div
        key={i}
        className="absolute w-2 h-2 bg-white rounded-full opacity-80 blur-[1px] animate-sparkle"
        style={{
          top: `${Math.random() * 100}%`,
  ...
  <div className="absolute inset-0 rounded-full p-[5px] bg-gradient-to-r from-pink-500 via-yellow-400 via-green-400 via-blue-500 to-purple-600 animate-spin-slow shadow-[0_0_30px_10px_rgba(255,255,255,0.1)]">
    <div className="w-full h-full rounded-full bg-black bg-opacity-20 blur-[1px] backdrop-blur-md" />
  </div>

  {/* 🖼 Profile with inner glow border */}
  <div className="relative z-10 w-full h-full rounded-full p-[5px] bg-gradient-to-tr from-blue-500 via-purple-400 to-pink-500 shadow-xl animate-pulse">
    <img
      src="/circle_profile.png"
      alt="Gayatri"
      className="w-full h-full object-cover rounded-full transition-transform duration-700 ease-in-out group-hover:scale-110 shadow-[0_0_25px_rgba(255,255,255,0.2)]"
    />
  </div>
