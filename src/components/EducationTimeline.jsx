...
const EducationTimeline = () => {
  return (
    <section className="min-h-screen py-16 px-4 sm:px-10 font-[ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,'Noto Sans',sans-serif] bg-[#0e0e0e]">
      <div className="outer-container max-w-6xl mx-auto">
        <motion.h2
        ...
        <div className="relative max-w-4xl mx-auto pl-10">
          ...
          {educationData.map((edu, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative w-full pl-14 pr-6 py-6 mb-10 bg-white/10 border border-white/20 rounded-2xl backdrop-blur-md shadow-lg"
            >
              {/* Dot and icon */}
